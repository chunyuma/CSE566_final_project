...
def read_class_count(megan_file, taxtree):
...
if __name__ == '__main__':
    args = parseargs()
    taxtree = build_taxtree(args.taxid_name_dump, args.taxid_nodes_dump)
    taxid_to_abundance = read_class_count(args.megan_class_count, taxtree)
